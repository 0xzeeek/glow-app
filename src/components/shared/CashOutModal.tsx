          ...
          {showSuccess ? (
            <View style={styles.successContainer}>
              <View style={styles.successContent}>
                ...
                <Text style={styles.successSubtitle}>Withdrawn from your balance</Text>
              </View>
            </View>
          ) : (
            <>
              ...
              <View style={styles.quickAmounts}>
                {[0.25, 0.50, 0.75, 1.00].map(percentage => (
                  ...
                  >
                    <Text style={styles.quickAmountText}>{percentage * 100}%</Text>
                  </TouchableOpacity>
                ))}
              </View>
              ...
              <View style={styles.swipeContainer}>
                <View style={styles.swipeTrack}>
                  ...
                  <Text style={styles.swipeText}>SWIPE TO CASH OUT</Text>
                </View>
              </View>
            </>
          )}
      ...
      >
        ...
        >
          ...
          >
            ...
            <Text style={styles.paymentMethodText}>CRYPTO WALLET</Text>
          </TouchableOpacity>
        </Animated.View>
      </Modal>
    </Modal>
